...
export const GAMES: Game[] = [
  ...
  },
  {
    ...
    title: "Blocks",
    emoji: "🧱",
    description: "Fit falling polyominoes into the well. Clear lines to score.",
  ...
  },
  {
    ...
    title: "Brick Buster",
    emoji: "🧱",
    description: "Break every brick. Catch power-ups for wide paddle, laser, and multi-ball.",
